...
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://perfectfit:theozonelair@perfectfitdb.chdg6as3bxgl.us-east-2.rds.amazonaws.com:3306/perfectfitdb'
db = SQLAlchemy(app)
...
if __name__ == "__main__":
	...
	# print(len(db.session.query(Event).all()))
	# db.session.commit()